...
public class PaintView extends View {
    ...
    private Bitmap mBitmap/*, m1Bitmap*/;
    private Canvas mCanvas/*,m1Canvas*/;
    ...
    public void initialise (DisplayMetrics displayMetrics) {
        ...
        //m1Bitmap = Bitmap.createBitmap(width, height, Bitmap.Config.ARGB_8888);
        mCanvas = new Canvas(mBitmap);
        //m1Canvas = new Canvas(m1Bitmap);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //m1Canvas.drawColor(Color.GRAY);
        /*m1Paint.setAntiAlias(true);
        m1Paint.setColor(Color.WHITE);
        m1Paint.setTextSize(35.0f);
        m1Paint.setStrokeWidth(2.0f);
        m1Paint.setStyle(Paint.Style.STROKE);
        m1Paint.setShadowLayer(5.0f, 10.0f, 10.0f, Color.BLACK);*/
        // mCanvas.drawText(MyString, 20, 200, m1Paint);
